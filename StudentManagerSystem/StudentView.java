...
public class StudentView {
    /*
		后面会反复键盘录入，所以我们没必要执行一个方法就new一个Scanner
		所以将Scanner对象放到成员位置
	*/
	...
	/*
		...
		后面每个功能都需要使用数组，所以可以将数组放到成员位置
	*/
	Student[] students = new Student[50];
    
    /*
    	定义一个变量count，记录数组中有多少个对象，遍历元素不能全部遍历，
    	因为没有存对象的位置遍历出来都是null，再调用getxxx方法，会出现空指针
	...
	*/
            ...
            switch(num){
                ...
                case 5:
                    ...
                    if(key==0){
                        ...
                        break;//单结束switch，不结束循环
                    }else{
                        System.out.println("请按提示输入正确退出命令！");
                        break;
                    }
            }  
		}  
    ...
    private void findAllStudent(){
        ...
        //冒泡排序
        /*
        	排序是为了防止删除完之后再重新添加之前删除的序号对应的学生而发生乱序情况
        */
